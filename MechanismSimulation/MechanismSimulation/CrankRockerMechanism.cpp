...
void CrankRockerMechanism::checkGrashofTheorem(double shortest, double longest)
{
...
std::pair <double, double> CrankRockerMechanism::rangeOfThetaTwoAngle(double links[4], double shortest, double longest)
{
...
void CrankRockerMechanism::angleFinder(double links[4], double thetaTwoAngle, double thetaThreeAngle, double thetaFourAngle, double shortest, double longest)
{
