...
void DoubleCrankMechanism::checkGrashofTheorem(double shortest, double longest)
{
...
std::pair <double, double> DoubleCrankMechanism::rangeOfThetaTwoAngle(double links[4], double shortest, double longest)
{
...
void DoubleCrankMechanism::angleFinder(double links[4], double thetaTwoAngle, double thetaThreeAngle, double thetaFourAngle, double shortest, double longest)
{
...
void DoubleCrankMechanism::positionCalculator(double links[4], double thetaTwoAngle, double thetaThreeAngle, double thetaFourAngle)
{
